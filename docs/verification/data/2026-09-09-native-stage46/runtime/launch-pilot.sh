...
frozen="$audit/frozen"
source="$base/integrated-stage46-20260908/source-10500"
output="$base/pilot-coupled-10500-10510-20260909"
...
echo 'Native coupled source=83db41df2ec9c351c71e3aebe812509ddfd7262b; exact restart=10500; diagnostic target=10510; no method recovery'
