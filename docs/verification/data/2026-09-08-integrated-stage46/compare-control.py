...
base=Path('/home/wyf/code_dev/.benchmarks/hundun-piso-simple-product-20260903/trial-D0p02-zpi2-52'); audit=base/'integrated-stage46-20260908'
new=base/'pilot-integrated-10500-10510-20260908'; old=base/'control-mainline-10500-10510-20260908'
def sha(p):
 h=hashlib.sha256()
 with p.open('rb') as f:
