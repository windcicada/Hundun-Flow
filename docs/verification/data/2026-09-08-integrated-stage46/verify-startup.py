...
base=Path('/home/wyf/code_dev/.benchmarks/hundun-piso-simple-product-20260903/trial-D0p02-zpi2-52');a=base/'integrated-stage46-20260908';run=base/'long-integrated-35000-20260908';snap=a/'startup-prefix'
svc='hundun-re3900-integrated-long-20260908.service'
...
g=(a/'source-10510/Restart/current').read_text().strip()
with (a/'startup-runtime.log').open('x') as f:subprocess.check_call(['python3',str(a/'frozen/v04_evidence_validate.py'),'runtime',str(snap/'evidence.jsonl'),'--run-start-manifest',str(a/'source-10510/Restart'/g/'manifest.bin')],stdout=f,stderr=subprocess.STDOUT)
...
subprocess.check_call(['sha256sum','--check',str(a/'SOURCE-LONG.sha256')],cwd=str(a/'source-10510'),stdout=subprocess.DEVNULL)
