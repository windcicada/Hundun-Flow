...
frozen="$audit/frozen"
source="$audit/source-10510"
output="$base/long-integrated-35000-20260908"
...
echo 'Integrated source=f4f04eccc4f159cf7aa55e4244cb36b7e642cb77; exact restart=10510; target=35000; no method recovery'
