...
struct ReactingTransportFluxAccess;
} // namespace detail
...
private:
  ...
  double value_for_reacting_transport(mesh::LocalFaceId) const;
  ...
  friend struct detail::ReactingTransportFluxAccess;
};
