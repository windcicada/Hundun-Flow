...
if(NOT DEFINED HUNDUN_SOURCE_ROOT OR
  ...
  message(FATAL_ERROR "Task 21 tests-off contract inputs are incomplete")
endif()
...
execute_process(
  COMMAND ${command} -E -P
          "${HUNDUN_SOURCE_ROOT}/tests/cmake/task21_header_preprocess.cpp"
...
if(NOT preprocess_result EQUAL 0)
  message(FATAL_ERROR "Task 21 tests-off preprocessing failed: ${preprocess_error}")
endif()
foreach(test_name IN ITEMS
    IdealGasClosureTestAccess
    IdealGasClosureDiagnosticTestAccess
    uniform_enthalpy_rate
    inject_ideal_gas_failure)
  string(FIND "${preprocessed}" "${test_name}" position)
  if(NOT position EQUAL -1)
    message(FATAL_ERROR "Task 21 tests-off header retains ${test_name}")
  endif()
endforeach()
...
if(NOT compile_result EQUAL 0)
  message(FATAL_ERROR "Task 21 public consumer failed: ${compile_error}")
endif()
