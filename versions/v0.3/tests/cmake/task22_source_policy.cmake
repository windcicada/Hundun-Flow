...
file(READ "${HUNDUN_SOURCE_ROOT}/src/CMakeLists.txt" product_cmake_text)
file(READ "${HUNDUN_SOURCE_ROOT}/tests/CMakeLists.txt" test_cmake_text)
set(cmake_text "${product_cmake_text}\n${test_cmake_text}")
file(READ "${HUNDUN_SOURCE_ROOT}/src/flow_adaptive_time_control.cpp" flow_text)
file(READ "${HUNDUN_SOURCE_ROOT}/src/flow_adaptive_time_control_detail.hpp"
     detail_text)
file(READ "${HUNDUN_SOURCE_ROOT}/src/diag_time_control.cpp"
     diagnostics_text)
