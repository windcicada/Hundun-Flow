...
struct ImmersedFlowActiveExchangeData final {
  std::size_t owned_active_count{};
  std::size_t ghost_active_count{};
  runtime::HaloPerformanceCounters pressure;
  std::array<runtime::HaloPerformanceCounters, 3> momentum;
};
...
struct ImmersedFlowAccess final {
  ...
  static ImmersedFlowActiveExchangeData
