...
function(hundun_assert_public_dependency_policy root)
  ...
  foreach(candidate IN LISTS candidate_files)
    ...
    set(is_cantera_maintainer_builder FALSE)
    if(relative_path STREQUAL "cmake/build_bundled_cantera_linux_cpu.sh")
      set(is_cantera_maintainer_builder TRUE)
    endif()
    ...
    if(has_interpreter_dependency AND NOT is_cantera_maintainer_builder)
      message(FATAL_ERROR
