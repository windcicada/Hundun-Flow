...
using hundun::v04::chemistry::CompositionIdentity;
using hundun::v04::chemistry::SpeciesIdentity;
...
CompositionIdentity two_species_identity() {
  ...
  identity.fingerprint =
      hundun::v04::chemistry::composition_identity_fingerprint(identity);
  return identity;
}
...
void test_all_species_identity_and_ordered_fingerprint() {
  ...
  hundun::v04::chemistry::validate_composition_identity(identity);
  ...
  HUNDUN_CHECK(
      hundun::v04::chemistry::composition_identity_fingerprint(reordered) !=
      identity.fingerprint);

  auto missing_last_species = identity;
  missing_last_species.species.pop_back();
  expect_invalid([&] {
    hundun::v04::chemistry::validate_composition_identity(missing_last_species);
  });

  auto changed_elements = identity;
  changed_elements.species[0].element_counts[1] = 3;
  HUNDUN_CHECK(
      hundun::v04::chemistry::composition_identity_fingerprint(changed_elements) !=
      identity.fingerprint);
}
...
void test_identity_validation_rejects_invalid_shape_and_values() {
  ...
  expect_invalid([&] {
    hundun::v04::chemistry::validate_composition_identity(empty_elements);
  });

  auto wrong_shape = identity;
  wrong_shape.species[1].element_counts.pop_back();
  wrong_shape.fingerprint =
      hundun::v04::chemistry::composition_identity_fingerprint(wrong_shape);
  expect_invalid([&] {
    hundun::v04::chemistry::validate_composition_identity(wrong_shape);
  });

  auto negative_count = identity;
  negative_count.species[0].element_counts[0] = -1;
  negative_count.fingerprint =
      hundun::v04::chemistry::composition_identity_fingerprint(negative_count);
  expect_invalid([&] {
    hundun::v04::chemistry::validate_composition_identity(negative_count);
  });

  auto zero_weight = identity;
  zero_weight.species[0].molecular_weight_kg_per_kmol = 0.0;
  zero_weight.fingerprint =
      hundun::v04::chemistry::composition_identity_fingerprint(zero_weight);
  expect_invalid([&] {
    hundun::v04::chemistry::validate_composition_identity(zero_weight);
  });
  ...
  non_finite_weight.fingerprint =
      hundun::v04::chemistry::composition_identity_fingerprint(non_finite_weight);
  expect_invalid([&] {
    hundun::v04::chemistry::validate_composition_identity(non_finite_weight);
  });
  ...
  duplicate_species.fingerprint =
      hundun::v04::chemistry::composition_identity_fingerprint(duplicate_species);
  expect_invalid([&] {
    hundun::v04::chemistry::validate_composition_identity(duplicate_species);
  });
}
...
void test_total_thermochemical_enthalpy_uses_all_species() {
  ...
  const double h_tc =
      hundun::v04::chemistry::mixture_total_thermochemical_enthalpy_j_per_kg(
  ...
  hundun::v04::chemistry::ThermochemicalPoint point;
...
void test_chemistry_status_and_report_contract() {
  using hundun::v04::chemistry::ChemistryStatus;
  ...
  hundun::v04::chemistry::ChemistryIntervalReport report;
